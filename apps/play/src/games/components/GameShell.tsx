      ...
      {(gameState === 'playing' || gameState === 'paused') && (
        <header style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 22, color: '#ffffff', fontWeight: 800, minWidth: 60, textAlign: 'right' }}>
              {score}
            </span>
          </div>
      ...
      {gameState === 'paused' && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: 26, fontWeight: 800, color: '#fff', margin: '0 0 8px 0' }}>
              Jogo Pausado ⏸
            </h3>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <h3 style={{ margin: 0, fontSize: 22, fontWeight: 800 }}>Conquistas (Awards)</h3>
              </div>
              <button
      ...
      {gameState === 'victory' && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: 32, fontWeight: 800, color: '#fff', margin: '0 0 6px 0' }}>
              VOCÊ VENCEU!
            </h2>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 36, fontWeight: 800, color: '#fff' }}>{finalScore}</div>
            </div>
      ...
      {gameState === 'gameover' && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 60, marginBottom: 8 }}>💪</div>
            <h2 style={{ fontSize: 28, fontWeight: 800, color: '#fff', margin: '0 0 6px 0' }}>
              NÃO DESISTA!
            </h2>
